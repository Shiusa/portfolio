...
export default function Home() {
	...
	return (
		<div className="w-full h-full flex flex-col items-center overflow-y-scroll py-[5%] text-gray-200 px-[4%] scrollbar-hidden">
			<motion.div className="w-full flex flex-col items-center justify-center mb-[50%]"
				ref={ref}
				variants={{
					hidden: {
						opacity: 1
